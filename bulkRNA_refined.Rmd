...
#generate heatmap after ordering rows and inputting symbols (Figure 1 and 3)
```{r}
...
#PCA plot for Naive vs Effectors genes (Figure 3)
```{r}
...
#gsea plots for Celltype1 vs Celltype2 (Figure 1 and 3)
```{r}
